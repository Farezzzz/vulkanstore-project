    ...
    <table class="w-full">
        ...
        <tbody class="text-[14px] text-gray-700">
            ...
            <tr class="border-b border-gray-100">
                ...
                <td class="px-8 py-5">
                    <span class="rounded-full bg-green-100 px-3 py-1 text-[11px] font-semibold text-green-700">LUNAS</span>
                </td>
            </tr>
            ...
            <tr class="border-b border-gray-100">
                ...
                <td class="px-8 py-5">
                    <span class="rounded-full bg-red-100 px-3 py-1 text-[11px] font-semibold text-red-700">BELUM LUNAS</span>
                </td>
            </tr>
